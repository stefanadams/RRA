...
'		SQLStatement 	= "SELECT id, name, sellername, sequencenumber FROM items WHERE status <> 'Complete' And status <> 'Bidding'"
		...
		case else SQLStatement = SQLStatement & " Order By id"
		End Select
		objRS.Open SQLStatement, objConn, 3, 3
		maxsort = objRS.recordcount
	...
	'Display results in a nicely-formatted table.
		...
		Response.Write "<B><U><a href='admin_viewitems.asp?sort=n'>Item</a></U></B></TD>"
		Response.Write "<TD align='left'><FONT face='verdana' color='#000000' size='2'>"
		Response.Write "<B><U><a href='admin_viewitems.asp?sort=d'>Donor</a></U></B></TD>"
		Response.Write "<TD align='left'><FONT face='verdana' color='#000000' size='2'>"
		Response.Write "<B><U><a href='admin_viewitems.asp?sort=s'>Order</a></U></B></TD></TR>"
		...
		Do While objRS.EOF <> True
			...
			Response.Write "<TR>"
			Response.Write "<TD align='left'><FONT face='verdana' color='#000000' size='2'><a class='item' href='admin_edit_item.asp?id=" & id & "'>" & id & ": " & name & "</A></TD>"
			Response.Write "<TD align='left'><FONT face='verdana' color='#000000' size='2'>" & sellername & "</TD>"
			Response.Write "<TD align='right'><FONT face='verdana' color='#000000' size='2'><a class='item' href='admin_edit_order.asp?id=" & id & "&sq=" & order & "&max=" & maxsort & "'>" & order & "</A></TD>"
			Response.Write "</TR>"
