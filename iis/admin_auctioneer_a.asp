...
<%
		SQLStatement	= "SELECT id, name, status, sellername, suggestedprice, bid, bidderID, timer, timeradmin, advertisement, active, moreinfo FROM items WHERE (status = 'Bidding' Or status = 'Halt') And Auctioneer = 0 Order By SequenceNumber"
