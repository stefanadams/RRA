	...
	*/
	...
	function setupMembership(){
		...
		if(!$anonGroupID){
			...
			sql("insert into membership_grouppermissions set groupID='$anonGroupID', tableName='contacts', allowInsert=0, allowView=0, allowEdit=0, allowDelete=0");
			sql("insert into membership_grouppermissions set groupID='$anonGroupID', tableName='rotarians', allowInsert=0, allowView=0, allowEdit=0, allowDelete=0");
			sql("insert into membership_grouppermissions set groupID='$anonGroupID', tableName='donations', allowInsert=0, allowView=0, allowEdit=0, allowDelete=0");
		...
		if(sqlValue("select count(1) from membership_grouppermissions where groupID='$adminGroupID'")<4){
			sql("delete from membership_grouppermissions where groupID='$adminGroupID'");
			// set admin group permissions
			sql("insert into membership_grouppermissions set groupID='$adminGroupID', tableName='contacts', allowInsert=1, allowView=3, allowEdit=3, allowDelete=3");
			sql("insert into membership_grouppermissions set groupID='$adminGroupID', tableName='rotarians', allowInsert=1, allowView=3, allowEdit=3, allowDelete=3");
			sql("insert into membership_grouppermissions set groupID='$adminGroupID', tableName='donations', allowInsert=1, allowView=3, allowEdit=3, allowDelete=3");
