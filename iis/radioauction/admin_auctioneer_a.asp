...
<%
		SQLStatement	= "SELECT id, name, status, sellername, suggestedprice, bid, timer, timeradmin, advertisement, active FROM items WHERE status = 'Bidding' And Auctioneer = 0 Order By SequenceNumber"
...
'-----------------
		...
		'end of row
		Response.Write "<td valign='top' style='border-right: 1 solid #808080; border-bottom: 1 solid #808080; border-right; 1 solid #808080'><font size='1'><a href='admin_start_auction_03.asp?id=" & objRS("id") & "&auctioneer=a'>Start Now</a></font></td>"
		Response.Write "</tr>"
		objRS.MoveNext
		wend
