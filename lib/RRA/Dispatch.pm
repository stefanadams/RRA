...
sub dispatch_args {{
	...
	table => [
		...
		'api/seqitems'			=> { app => 'API::SeqItems', rm => 'seqitems' },
		'api/seqitems/:rm'		=> { app => 'API::SeqItems' },
		'api/rotarians'			=> { app => 'API::SeqItems', rm => 'rotarians' },
		'api/rotarians/:rm'		=> { app => 'API::SeqItems' },
		'api/rotariancompliance'	=> { app => 'API::RotarianCompliance', rm => 'compliance' },
		'api/rotariancompliance/:rm'	=> { app => 'API::RotarianCompliance' },
		'api/rotarianleaders'		=> { app => 'API::RotarianLeaders', rm => 'leaders' },
		'api/rotarianleaders/:rm'	=> { app => 'API::RotarianLeaders' },
		'api/:rm/*'			=> { app => 'API' },
		'xls/:rm'			=> { app => 'XLS' },
