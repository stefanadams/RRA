...
'strConn = "DRIVER={MySQL ODBC 3.51 Driver};SERVER=mysql.borgia.com;PORT=3306;DATABASE=washingtonrotary_auction;USER=washingtonrotary;PASSWORD=harris;OPTION=3;"
