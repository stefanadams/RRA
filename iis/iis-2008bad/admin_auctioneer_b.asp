...
<%
		SQLStatement	= "SELECT id, name, status, sellername, suggestedprice, bid, bidderID, timer, timeradmin, advertisement, active FROM items WHERE (status = 'Bidding' Or status = 'Halt') And Auctioneer = 1 Order By SequenceNumber"
