	...
	<?php
		...
		while($row=mysql_fetch_row($res)){
			...
			<tr>
				...
				<td class="tdCell" align="left"><a href="pageEditOwnership.php?recID=<?php echo $row[3]; ?>"><img src="images/data_icon.gif" border="0" alt="View record details" title="View record details"></a> <?php echo substr(getCSVData($row[0], $row[1]), 0, 15); ?> ...</a></td>
				</tr>
			<?php
		}
	?>
...
<!-- ################# Top Members ######################## -->
	...
	<?php
		$res=sql("select memberID, count(1) from membership_userrecords group by memberID order by 2 desc limit 5");
		while($row=mysql_fetch_row($res)){
			?>
			<tr>
