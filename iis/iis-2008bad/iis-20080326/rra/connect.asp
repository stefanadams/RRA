...
strConn = "DRIVER={MySQL ODBC 3.51 Driver};SERVER=mysql.borgia.com;PORT=3306;DATABASE=washrotary;USER=washingtonrotary;PASSWORD=harris;"
...
Sub Connect
	strConn = "DRIVER={MySQL ODBC 3.51 Driver};SERVER=localhost;PORT=3306;DATABASE=washrotary;USER=washingtonrotary;PASSWORD=harris;"
	Set objConn = Server.CreateObject("ADODB.Connection")
	Set objRS = Server.CreateObject("ADODB.Recordset") 
	objConn.Open strConn
end Sub
