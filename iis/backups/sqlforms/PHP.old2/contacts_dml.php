...
function insert(){
	...
	if($contact_name== ""){
		echo StyleSheet() . "\n\n<div class=Error>" . $Translation["error:"] . " 'Business Name': " . $Translation['field not null'] . "</div>";
		exit;
	}
	...
	sql("insert into contacts (contact_chamberid, contact_name, contact_type, contact_primary, contact_secondary, contact_address, contact_city, contact_state, contact_zip, contact_phone, contact_email, contact_dns, contact_lastyear, contact_comments, rotarian_id) values (" . (($contact_chamberid != "") ? "'$contact_chamberid'" : "NULL") . ", " . (($contact_name != "") ? "'$contact_name'" : "NULL") . ", " . (($contact_type != "") ? "'$contact_type'" : "NULL") . ", " . (($contact_primary != "") ? "'$contact_primary'" : "NULL") . ", " . (($contact_secondary != "") ? "'$contact_secondary'" : "NULL") . ", " . (($contact_address != "") ? "'$contact_address'" : "NULL") . ", " . (($contact_city != "") ? "'$contact_city'" : "NULL") . ", " . (($contact_state != "") ? "'$contact_state'" : "NULL") . ", " . (($contact_zip != "") ? "'$contact_zip'" : "NULL") . ", " . (($contact_phone != "") ? "'$contact_phone'" : "NULL") . ", " . (($contact_email != "") ? "'$contact_email'" : "NULL") . ", " . (($contact_dns != "") ? "'$contact_dns'" : "NULL") . ", " . (($contact_lastyear != "") ? "'$contact_lastyear'" : "NULL") . ", " . (($contact_comments != "") ? "'$contact_comments'" : "NULL") . ", " . (($rotarian_id != "") ? "'$rotarian_id'" : "NULL") . ")");
...
function form($selected_id = "", $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_rotarian_id->Query = "select id, concat(rotarian_name, '') from rotarians order by 2";
	...
	if($selected_id){
		...
		$templateCode=str_replace('<%%VALUE(contact_lastyear)%%>', htmlspecialchars($row['contact_lastyear'], ENT_QUOTES), $templateCode);
		...
		$templateCode=str_replace('<%%VALUE(contact_lastyear)%%>', '', $templateCode);
