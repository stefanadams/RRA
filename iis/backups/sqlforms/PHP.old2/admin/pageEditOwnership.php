	...
	<table border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td align="left" class="tdFormInput" width="460">
				<?php
					echo htmlSQLSelect('memberID', "select memberID, memberID from membership_users where groupID='$groupID' order by memberID", $memberID);
				?>
			...
			<td align="left" class="tdFormInput">
				<?php 
					...
					if($row=mysql_fetch_assoc($res)){
						...
						foreach($field as $fn){
							if(@is_file(dirname(__FILE__)."/../".$Translation['ImageFolder'].$row[$fn])){
